...
static void test_parse_number() {
    ...
    TEST_NUMBER(1.234E-10, "1.234E-10");
    TEST_NUMBER(0.0, "1e-10000"); // 超过double精度
    TEST_NUMBER(1.0000000000000002, "1.0000000000000002"); // 最小的大于1的数
    TEST_NUMBER( 4.9406564584124654e-324, "4.9406564584124654e-324"); // 非规范数
